...
class Search {
  // 1. Describe and inintiate our object
  constructor() {
    this.addSearchHTML();
      ...
      this.resultsDiv.html(`
                <div class="row">
                    <div class="one-third">
                        ...
                        ${results.generalInfo.length ? '<ul class="link-list min-list">' : '<p>No blogs or general information results were found!</p>'}
                    ...
                    <div class="one-third">
                        ...
                        ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No program results were found! <a href="${universityData.root_url}/programs">View all programs.</a></p>`}
                        ${results.programs.map(item => `<li><a href="${item.permalink}">${item.title}</a></li>`).join('')}
                        ${results.programs.length ? '</ul>' : ''}

                        <h2 class='search-overlay__section-title'>Professors:</h2>
                        ${results.professors.length ? '<ul class="professor-cards">' : `<p>No professors were found!</p>`}
                        ${results.professors.map(item => `
                            <li class="professor-card__list-item">
                                <a class="professor-card" href="${item.permalink}">
                                    <img class="professor-card__image" src="${item.image}" alt="teacher image">
                    ...
                    <div class="one-third">
                        ...
                        ${results.campuses.length ? '<ul class="link-list min-list">' : `<p>No campuses results found! <a href="${universityData.root_url}/campuses">View all campuses.</a></p>`}
                        ...
                        ${results.events.length ? '' : `<p>No event results found! <a href="${universityData.root_url}/events">View all events.</a></p>`}
